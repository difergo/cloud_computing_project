...
insert into tbl_quotes (id,name,symbol,price,last_update,currency_id) values (2,'Libra','GBP',4000.4,CURRENT_TIMESTAMP(),1);
insert into tbl_quotes (id,name,symbol,price,last_update,currency_id) values (3,'Dolar','USD',4000.4,CURRENT_TIMESTAMP(),2);
